...
import { LayoutDashboard, Users, Video, LogOut, Settings, ShieldAlert, LifeBuoy, Mail, HardDrive, Sun, Moon, Share2, Award } from 'lucide-react';
...
const AdminSidebar = ({ onClose }) => {
    ...
    const navItems = [
        ...
        { path: '/admin/apps', icon: <HardDrive size={20} />, label: 'App Releases' },
    ];
