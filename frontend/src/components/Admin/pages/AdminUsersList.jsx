...
const AdminUsersList = () => {
    ...
    return (
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden animate-fade-in flex flex-col h-full min-h-[500px]">
            {/* Header & Search */}
            <div className="p-6 border-b border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4 bg-slate-50/50 dark:bg-slate-800/10">
                <h2 className="text-xl font-bold text-slate-800 dark:text-white">Platform Users</h2>
                <div className="relative w-full sm:w-72">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 border border-slate-200 dark:border-slate-800 rounded-xl bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-200 focus:bg-white dark:focus:bg-slate-900 focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 outline-none transition-all shadow-inner"
                    />
                </div>
            </div>
                                ...
                                <tr key={user.id} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/30 transition-colors group">
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-3">
                                            {user.profile_pic ? (
                                                <img src={user.profile_pic} alt="" className="w-10 h-10 rounded-full object-cover bg-slate-100 dark:bg-slate-800" />
                                            ) : (
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-sm font-medium text-slate-600 dark:text-slate-300">{user.xp} XP</span>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4">
                                        <div className="text-sm text-slate-600 dark:text-slate-400 space-y-0.5">
                                            <p><span className="font-semibold text-slate-800 dark:text-slate-200">{user._count.videos}</span> Courses</p>
                                            <p><span className="font-semibold text-slate-800 dark:text-slate-200">{user._count.quizzes}</span> Quizzes</p>
                                            <p><span className="font-semibold text-slate-800 dark:text-slate-200">{user._count.certificates}</span> Certs</p>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4">
            ...
            <div className="px-6 py-4 border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 text-xs text-slate-500 dark:text-slate-400 text-right">
