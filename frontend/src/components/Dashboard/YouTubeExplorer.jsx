            ...
            <div className="flex flex-col items-center text-center space-y-8 py-8 md:py-12">
                ...
                >
                    <div className="flex items-center justify-center gap-4 mb-2">
                        <div className="p-4 bg-red-500 text-white rounded-[2rem] shadow-xl shadow-red-500/20 rotate-3 hover:rotate-0 transition-transform duration-500">
                            <Youtube size={32} />
                        </div>
                        <div className="flex flex-col items-start text-left">
                            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-red-500 mb-1">Advanced Engine</span>
                ...
                <form onSubmit={handleSearch} className="relative w-full max-w-2xl group">
                    ...
                    <div className="relative flex items-center bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-[2rem] p-2 shadow-2xl shadow-gray-200/50 dark:shadow-none transition-all duration-500 focus-within:ring-4 focus-within:ring-red-500/10 focus-within:border-red-500/30">
                        ...
                        <input
                            type="text"
                            placeholder="Search for tutorials, courses, or crash courses..."
                            value={query}
                            onChange={(e) => setQuery(e.target.value)}
                            className="flex-1 bg-transparent border-none py-4 px-4 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-slate-600 focus:ring-0 outline-none text-base md:text-lg font-medium"
                        />
                        <button
                            type="submit"
                            disabled={loading}
                            className="bg-gray-900 dark:bg-red-600 hover:bg-gray-800 dark:hover:bg-red-700 text-white px-8 py-4 rounded-[1.5rem] font-bold text-sm uppercase tracking-widest transition-all flex items-center gap-2 shadow-lg disabled:opacity-50"
                        >
                ...
                <div className="relative bg-white dark:bg-slate-900 rounded-[2rem] p-6 md:p-8 border border-gray-100 dark:border-slate-800">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                        <div className="space-y-1 text-center md:text-left">
                            ...
                            <h2 className="text-xl md:text-2xl font-black text-gray-900 dark:text-white">Smart Course Generator</h2>
                        ...
                        <form onSubmit={handleGetRecommendations} className="w-full md:w-auto flex flex-col md:flex-row items-center gap-4">
                            ...
                            <button
                                ...
                                className="w-full md:w-auto bg-gradient-to-br from-orange-500 to-red-600 hover:shadow-lg hover:shadow-orange-500/25 text-white px-8 py-3.5 rounded-[1.25rem] font-black uppercase tracking-widest text-xs transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                            >
                ...
                {activePreview && (
                    ...
                    >
                        ...
                        >
                            <button
                                onClick={() => setActivePreview(null)}
                                className="absolute top-6 right-6 z-10 bg-white/10 hover:bg-white/20 backdrop-blur-md text-white p-3 rounded-full transition-all duration-300 opacity-0 group-hover:opacity-100 scale-90 group-hover:scale-100"
                            >
