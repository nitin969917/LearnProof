...
const DailyTasksCard = () => {
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-orange-100 dark:border-gray-700 overflow-hidden transform transition-all duration-300 hover:shadow-md dark:shadow-gray-900/50">
            ...
            <div className="p-4">
                {/* Add Task Input */}
                <form onSubmit={handleAddTask} className="relative mb-3">
                    <input
                        type="text"
                        value={newTask}
                ...
                <div className="space-y-2 max-h-48 overflow-y-auto pr-1 custom-scrollbar">
                    {tasks.length === 0 ? (
                        <div className="text-center py-2 text-gray-400 dark:text-gray-500 flex flex-col items-center">
                        ...
                        tasks.map((task) => (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="p-1.5 text-gray-400 dark:text-gray-500 opacity-100 xl:opacity-0 xl:group-hover:opacity-100 hover:text-red-500 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-md transition-all duration-200"
                                >
                                    <Trash2 size={14} />
                                </button>
                            </div>
