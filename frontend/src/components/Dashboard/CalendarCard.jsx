...
const CalendarCard = () => {
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-orange-100 dark:border-gray-700 relative transform transition-all duration-300 hover:shadow-md dark:shadow-gray-900/50">
            <div className="p-4 sm:p-5 rounded-t-xl border-b border-orange-50 dark:border-gray-700 bg-gradient-to-r from-orange-50/50 dark:from-gray-800 to-white dark:to-gray-800 flex items-center justify-between">
