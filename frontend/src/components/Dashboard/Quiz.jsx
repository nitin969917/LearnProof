...
const Quiz = () => {
    ...
    if (quizData) {
        ...
        return (
            <div className="min-h-screen bg-gray-50 dark:bg-gray-800 transition-colors duration-300">
                {/* Header for Quiz */}
                <div className="sticky top-0 z-20 bg-white/80 dark:bg-gray-700/80 backdrop-blur-md border-b dark:border-gray-600/50 p-4">
                        ...
                        {questions.map((q, idx) => {
                            ...
                            return (
                                <motion.div 
                                    ...
                                    className="bg-white dark:bg-gray-700 rounded-2xl p-6 sm:p-8 shadow-sm border border-gray-100 dark:border-gray-600/50"
                                >
                                    ...
                                    {hasOptions ? (
                                            ...
                                            {q.options.map((opt, optIdx) => (
                                                <label 
                                                    ...
                                                    className={`group relative flex items-center p-4 rounded-xl border-2 cursor-pointer transition-all duration-200 ${
                                                        ...
                                                        : 'bg-gray-50 dark:bg-slate-700/30 border-gray-100 dark:border-gray-600 hover:border-orange-200 dark:hover:border-orange-500/50'
                                                    }`}
                                                >
                                                    <input
                                                        type="radio"
                                        ...
                                        <div className="ml-0 sm:ml-12">
                                            <textarea
                                                ...
                                                rows={3}
                                                className="w-full p-4 rounded-xl border-2 border-gray-100 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-800 dark:text-white focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-all placeholder:text-gray-400 dark:placeholder:text-slate-600"
                                            />
                ...
                {/* Footer Submit Bar */}
                <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-700 border-t dark:border-gray-600 p-4 z-30 shadow-[0_-4px_20px_rgba(0,0,0,0.05)] transition-colors">
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-800 p-4 transition-colors duration-300">
                <motion.div
                    ...
                    className="bg-white dark:bg-gray-700 p-10 rounded-3xl shadow-2xl max-w-lg w-full text-center border border-gray-100 dark:border-gray-600/50 relative overflow-hidden"
                >
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-6 mb-8 border border-gray-100 dark:border-gray-600/50">
    ...
    if (selectedHistoryQuiz) {
        ...
        return (
            <div className="min-h-screen bg-gray-50 dark:bg-gray-800 p-4 sm:p-8 transition-colors duration-300">
                <div className="max-w-4xl mx-auto">
                    <button
                        onClick={() => setSelectedHistoryQuiz(null)}
                        className="mb-8 flex items-center gap-2 px-5 py-2.5 bg-white dark:bg-gray-700 text-gray-700 dark:text-white font-bold rounded-xl border border-gray-100 dark:border-gray-600/50 shadow-sm hover:bg-gray-50 dark:hover:bg-slate-700 transition-all active:scale-95"
                    >
                        <ArrowLeft size={18} />
                        Back to Selection
                    </button>
                    ...
                    <motion.div 
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        className="bg-white dark:bg-gray-700 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-600/50 overflow-hidden"
                    >
                        {/* Summary Header */}
                        <div className="p-6 sm:p-10 border-b dark:border-gray-600/50 bg-gray-50/50 dark:bg-gray-800/30 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
                            ...
                            <div className="text-center sm:text-right bg-white dark:bg-gray-700 p-6 rounded-2xl shadow-inner border border-gray-100 dark:border-gray-600/50 min-w-[140px]">
                                    ...
                                    <div key={idx} className="relative">
                                        ...
                                        <div className="grid gap-3 sm:ml-12">
                                            {q.options.map((opt, optIdx) => {
                                                ...
                                                let borderStyle = "border-gray-100 dark:border-gray-600/50";
                                                let bgStyle = "bg-gray-50/50 dark:bg-gray-800/20";
            ...
            <div className="space-y-12">
                ...
                <section>
                    ...
                    {playlists.length === 0 ? (
                        ...
                        <div className="relative group">
                            ...
                            <button
                                onClick={() => scroll('left')}
                                className="absolute -left-4 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-white/90 dark:bg-gray-700/90 border border-orange-100 dark:border-gray-600 rounded-full shadow-xl flex items-center justify-center text-orange-500 opacity-0 group-hover:opacity-100 transition-all hover:scale-110 active:scale-95 hidden md:flex"
                            >
                                <ChevronLeft size={24} />
                            </button>
                            <button
                                onClick={() => scroll('right')}
                                className="absolute -right-4 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-white/90 dark:bg-gray-700/90 border border-orange-100 dark:border-gray-600 rounded-full shadow-xl flex items-center justify-center text-orange-500 opacity-0 group-hover:opacity-100 transition-all hover:scale-110 active:scale-95 hidden md:flex"
                            >
                            ...
                            >
                                {playlists.map(pl => (
                                    ...
                                    >
                                        <div className={`h-full group/card relative overflow-hidden bg-white dark:bg-gray-700 rounded-3xl p-6 border transition-all duration-300 ${
                                            pl.is_eligible 
                                            ? 'border-orange-100 dark:border-gray-600 shadow-sm hover:shadow-xl hover:border-orange-200 dark:hover:border-orange-500/30' 
                                            ...
                                            <div className="flex flex-col h-full justify-between gap-6">
                                                ...
                                                <div className="mt-4 pt-4 border-t dark:border-gray-600/50 flex items-center justify-between">
                                                    {!pl.is_eligible ? (
                                                        <div className="flex items-center gap-2 px-3 py-2 bg-gray-50 dark:bg-gray-800/50 text-gray-400 dark:text-slate-500 rounded-xl text-xs font-bold uppercase tracking-widest border border-gray-100 dark:border-gray-600">
                                                            <Lock size={14} />
                                                            Locked
                                                        </div>
                                                    ) : (
                ...
                <section className="bg-white/40 dark:bg-gray-700/20 rounded-[2.5rem] p-8 border border-gray-100 dark:border-gray-600/30">
                    <div className="flex items-center justify-between mb-8">
                        ...
                        <div className="px-4 py-1.5 bg-white dark:bg-gray-700 rounded-xl border border-gray-100 dark:border-gray-600 shadow-sm text-xs font-bold text-gray-500 dark:text-slate-400">
                                ...
                                {history.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage).map(hist => (
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-4 flex-shrink-0 ml-2">
                                            ...
                                            <div className="w-8 h-8 rounded-full bg-gray-50 dark:bg-gray-800 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all scale-75 group-hover:scale-100 border dark:border-gray-600">
                                ...
                                <div className="flex items-center justify-center gap-2 pt-4">
                                    <button
                                        ...
                                        className={`p-2 rounded-xl border transition-all ${
                                            currentPage === 1 
                                            ? 'text-gray-300 dark:text-slate-700 border-gray-100 dark:border-gray-600 cursor-not-allowed' 
