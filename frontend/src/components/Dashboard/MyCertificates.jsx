        ...
        {certs.map((cert, index) => (
          ...
          >
            ...
            <div className="p-6 sm:p-8 flex flex-col flex-1 bg-white dark:bg-gray-800">
              ...
              <div className="mt-auto pt-6 border-t border-gray-100 dark:border-gray-700 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <a
                  ...
                  className="w-full sm:w-auto flex items-center justify-center gap-3 px-6 py-3 bg-gray-900 dark:bg-gray-700 text-white rounded-2xl font-black text-[10px] sm:text-xs uppercase tracking-widest transition-all shadow-lg hover:bg-orange-500 dark:hover:bg-orange-500 hover:scale-105 active:scale-95 group/btn"
                >
