...
export default function LanguageLearning() {
  ...
  return (
    <div className="flex flex-col gap-4 w-full mx-auto px-3 sm:px-6 lg:px-8 pt-3 pb-28">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-[repeat(auto-fill,minmax(210px,1fr))] gap-4 sm:gap-6">
