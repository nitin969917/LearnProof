    ...
    return (
        <div className="min-h-screen bg-slate-50 font-sans selection:bg-orange-200 flex">
            ...
            <div className="flex-1 min-w-0 flex flex-col">
                ...
                <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md shadow-2xs border-b border-gray-200/80 py-3 px-4 sm:px-8 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-2">
                            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-orange-50 text-orange-600 text-xs font-bold border border-orange-200">
                ...
                <main className="flex-1 p-4 sm:p-6 lg:p-8 max-w-6xl w-full mx-auto space-y-7 pb-20">
                    {/* ── Top Header Banner ── */}
                    <div id="overview" className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 sm:p-7 rounded-3xl border border-gray-200/80 shadow-[0_8px_24px_rgba(0,0,0,0.03)]">
                        <div>
                    ...
                    <div id="share-link" className="relative overflow-hidden bg-gradient-to-r from-orange-600 via-orange-500 to-amber-500 text-white rounded-3xl p-6 sm:p-8 shadow-xl shadow-orange-500/20">
                ...
                <div id="milestones" className="bg-white p-6 sm:p-7 rounded-3xl border border-gray-200/80 shadow-sm space-y-5">
                ...
                <div id="toolkit" className="bg-white p-6 sm:p-7 rounded-3xl border border-gray-200/80 shadow-sm space-y-6">
                ...
                <div id="signups" className="bg-white rounded-3xl border border-gray-200/80 shadow-sm p-6 sm:p-7">
