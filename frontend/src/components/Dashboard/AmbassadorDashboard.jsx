...
export default function AmbassadorDashboard() {
        ...
        return (
            <div className="min-h-[60vh] flex items-center justify-center">
                <div className="flex flex-col items-center gap-3">
                    ...
                    <p className="text-sm font-semibold text-gray-500 dark:text-gray-400">Loading Ambassador Portal...</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-6 max-w-6xl mx-auto pb-12 transition-colors">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-[320px] bg-gradient-to-b from-orange-500/10 via-amber-500/5 to-transparent pointer-events-none -z-10 dark:opacity-20" />

            {/* ── Top Header Banner ── */}
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white dark:bg-gray-800 p-5 sm:p-7 rounded-3xl border border-gray-200/80 dark:border-gray-700 shadow-sm transition-colors">
                <div>
                    <div className="flex items-center gap-2 flex-wrap">
                        <span className="text-xl">{currentTier.badge}</span>
                        <span className="text-xs font-bold uppercase tracking-wider text-orange-600 dark:text-orange-400 bg-orange-50 dark:bg-orange-950/40 px-2.5 py-0.5 rounded-full border border-orange-200 dark:border-orange-800/60">
                            {currentTier.name}
                        </span>
                        {referralData?.targetCollege && (
                            <span className="text-xs font-semibold text-slate-500 dark:text-gray-400 bg-slate-100 dark:bg-gray-700/60 px-2.5 py-0.5 rounded-full flex items-center gap-1 border border-gray-200/50 dark:border-gray-600">
                ...
                <div className="flex items-center gap-3">
                    <button
                        ...
                        disabled={refreshing}
                        className="p-2.5 text-gray-600 dark:text-gray-300 bg-orange-50 dark:bg-gray-700 hover:bg-orange-100 dark:hover:bg-gray-600 rounded-xl transition border border-orange-200 dark:border-gray-600 shadow-sm cursor-pointer"
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white font-bold text-xs sm:text-sm rounded-xl shadow-md shadow-orange-500/20 transition active:scale-95 cursor-pointer"
                    >
                        <Edit3 size={16} />
                ...
                <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    ...
                    <div className="bg-white/15 backdrop-blur-md p-3 sm:p-4 rounded-2xl border border-white/25 flex flex-col gap-3 min-w-[290px]">
                        <div className="flex items-center justify-between gap-2 bg-black/25 px-3.5 py-2.5 rounded-xl">
                            ...
                            <button
                                onClick={handleCopy}
                                className="p-1.5 hover:bg-white/20 rounded-lg transition active:scale-95 shrink-0 cursor-pointer"
                                title="Copy Link"
                            >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {/* Signups */}
                <div className="bg-white dark:bg-gray-800 p-5 rounded-2xl border border-gray-200/80 dark:border-gray-700 shadow-sm hover:shadow-md transition">
                    <div className="flex items-center justify-between">
                        <span className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Total Signups</span>
                        <div className="w-10 h-10 rounded-xl bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 flex items-center justify-center border border-emerald-100 dark:border-emerald-800/40">
                            <Users size={20} />
                        </div>
                    </div>
                    <div className="mt-3 flex items-baseline gap-2">
                        <span className="text-3xl font-black text-gray-900 dark:text-white">{signups}</span>
                    </div>
                ...
                <div className="bg-white dark:bg-gray-800 p-5 rounded-2xl border border-gray-200/80 dark:border-gray-700 shadow-sm hover:shadow-md transition">
                    <div className="flex items-center justify-between">
                        <span className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Total Link Clicks</span>
                        <div className="w-10 h-10 rounded-xl bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 flex items-center justify-center border border-blue-100 dark:border-blue-800/40">
                            <MousePointerClick size={20} />
                        </div>
                    </div>
                    <div className="mt-3 flex items-baseline gap-2">
                        <span className="text-3xl font-black text-gray-900 dark:text-white">{clicks}</span>
                    </div>
                ...
                <div className="bg-white dark:bg-gray-800 p-5 rounded-2xl border border-gray-200/80 dark:border-gray-700 shadow-sm hover:shadow-md transition">
                    <div className="flex items-center justify-between">
                        <span className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Conversion Rate</span>
                        <div className="w-10 h-10 rounded-xl bg-purple-50 dark:bg-purple-950/40 text-purple-600 dark:text-purple-400 flex items-center justify-center border border-purple-100 dark:border-purple-800/40">
                            <TrendingUp size={20} />
                        </div>
                    </div>
                    <div className="mt-3 flex items-baseline gap-2">
                        <span className="text-3xl font-black text-gray-900 dark:text-white">{convRate}%</span>
                    </div>
                ...
                <div className="bg-white dark:bg-gray-800 p-5 rounded-2xl border border-gray-200/80 dark:border-gray-700 shadow-sm hover:shadow-md transition">
                    <div className="flex items-center justify-between">
                        <span className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Current Perk</span>
                        <div className="w-10 h-10 rounded-xl bg-orange-50 dark:bg-orange-950/40 text-orange-600 dark:text-orange-400 flex items-center justify-center border border-orange-100 dark:border-orange-800/40">
                            <Gift size={20} />
                        </div>
                    </div>
                    <div className="mt-2 text-xs font-bold text-gray-900 dark:text-white line-clamp-2 leading-relaxed">
                        {currentTier.perk}
                    </div>
                    <div className="mt-2 text-[11px] text-orange-600 dark:text-orange-400 font-bold uppercase tracking-wider">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 sm:p-7 rounded-3xl border border-gray-200/80 dark:border-gray-700 shadow-sm space-y-5 transition-colors">
                <div className="flex items-center justify-between flex-wrap gap-2">
                    ...
                    <span className="text-xs font-bold text-orange-600 dark:text-orange-400 bg-orange-50 dark:bg-orange-950/40 px-3 py-1 rounded-full border border-orange-200 dark:border-orange-800/60">
                        ...
                        return (
                            <div
                                ...
                                className={`p-4 rounded-2xl border transition-all ${
                                    isReached
                                        ? 'bg-orange-50/40 dark:bg-orange-950/20 border-orange-200 dark:border-orange-800/60 shadow-sm'
                                        : 'bg-slate-50/70 dark:bg-gray-800/40 border-slate-200 dark:border-gray-700 opacity-70'
                                }`}
                            >
                                ...
                                <p className="text-[11px] text-gray-500 dark:text-gray-400 mt-1 leading-snug">{t.perk}</p>
                                {isReached && (
                                    <span className="inline-flex items-center gap-1 text-[10px] font-bold text-emerald-600 dark:text-emerald-400 mt-2">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 sm:p-7 rounded-3xl border border-gray-200/80 dark:border-gray-700 shadow-sm space-y-6 transition-colors">
                ...
                {activeToolkitTab !== 'qr-poster' ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {toolkitTemplates[activeToolkitTab]?.map((item) => (
                            <div 
                                key={item.id} 
                                className="p-4 rounded-2xl bg-orange-50/30 dark:bg-gray-900/40 border border-orange-100 dark:border-gray-700 hover:border-orange-200 dark:hover:border-gray-600 flex flex-col justify-between gap-3 transition hover:shadow-sm"
                            >
                                <div>
                                    <div className="flex items-center justify-between mb-2">
                                        <span className="text-xs font-bold text-gray-800 dark:text-gray-200 flex items-center gap-1">
                                            ...
                                            {item.platform === 'linkedin' && <ExternalLink size={14} className="text-blue-500" />}
                                            {item.platform === 'telegram' && <Send size={14} className="text-sky-500" />}
                                            {item.title}
                                        </span>
                                        <span className="text-[10px] font-bold text-orange-600 dark:text-orange-400 bg-orange-100 dark:bg-orange-950/40 px-2 py-0.5 rounded-full">
                                            {item.badge}
                                        </span>
                                    </div>
                                    <div className="p-3 bg-white dark:bg-gray-800 rounded-xl border border-orange-100/60 dark:border-gray-700 text-xs text-gray-700 dark:text-gray-300 leading-relaxed font-sans select-all whitespace-pre-line max-h-48 overflow-y-auto custom-scrollbar">
                                        {item.text}
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-2 pt-1">
                                    <button
                                        ...
                                        className="py-2 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 font-bold text-xs rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm transition active:scale-95 flex items-center justify-center gap-1.5 cursor-pointer"
                                    >
                    ...
                    /* QR Poster Kit View */
                    <div className="p-6 bg-gradient-to-br from-orange-50/60 to-amber-50/40 dark:from-gray-900/60 dark:to-gray-800/40 rounded-2xl border border-orange-200 dark:border-gray-700 flex flex-col md:flex-row items-center justify-between gap-8">
                        <div className="space-y-3 max-w-lg">
                            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-orange-100 dark:bg-orange-950/40 text-orange-700 dark:text-orange-400 text-xs font-bold">
                            ...
                            <div className="flex flex-wrap items-center gap-3 pt-2">
                                ...
                                <button
                                    onClick={handleCopy}
                                    className="px-4 py-2.5 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 font-bold text-xs rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm transition flex items-center gap-2 cursor-pointer"
                                >
                        ...
                        <div className="bg-white dark:bg-gray-800 p-5 rounded-2xl border border-orange-200 dark:border-gray-700 shadow-lg flex flex-col items-center gap-3 text-center shrink-0">
                            <img src={qrUrl} alt="Referral QR Code" className="w-48 h-48 rounded-xl object-contain bg-white p-2" />
                            <span className="font-mono text-xs font-bold text-orange-600 dark:text-orange-400 bg-orange-50 dark:bg-orange-950/40 px-3 py-1 rounded-lg border border-orange-200 dark:border-orange-800/60">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl border border-gray-200/80 dark:border-gray-700 shadow-sm p-6 sm:p-7 transition-colors">
                ...
                {referralData?.recentSignups && referralData.recentSignups.length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        {referralData.recentSignups.map((student, idx) => (
                            <div key={idx} className="flex items-center justify-between p-3.5 rounded-2xl bg-orange-50/40 dark:bg-gray-900/40 border border-orange-100 dark:border-gray-700 hover:bg-orange-50/70 dark:hover:bg-gray-700/50 transition">
                                <div className="flex items-center gap-3 min-w-0">
                                    <div className="w-10 h-10 rounded-full bg-orange-100 dark:bg-orange-950/40 text-orange-600 dark:text-orange-400 font-bold flex items-center justify-center text-sm overflow-hidden shrink-0 border border-orange-200 dark:border-orange-800/60">
                                        {student.profile_pic ? (
                                ...
                                <span className="text-[10px] font-bold text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/40 px-2.5 py-1 rounded-full border border-emerald-100 dark:border-emerald-800/40 shrink-0">
                                    Verified
                                </span>
                            </div>
                        ))}
            ...
            {isEditModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
                    <div className="bg-white dark:bg-gray-800 rounded-3xl max-w-md w-full p-6 border border-orange-100 dark:border-gray-700 shadow-2xl space-y-5">
                        <div className="flex items-center justify-between border-b border-orange-100 dark:border-gray-700 pb-3">
                            ...
                            <button
                                ...
                                className="p-1 text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 rounded-lg text-lg cursor-pointer"
                            >
                                &times;
                            </button>
                        </div>
                        ...
                        <form onSubmit={handleUpdateProfile} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-3.5 py-2.5 bg-orange-50/50 dark:bg-gray-900/60 border border-orange-200 dark:border-gray-700 rounded-xl text-sm font-mono font-bold text-orange-600 dark:text-orange-400 uppercase focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-3.5 py-2.5 bg-orange-50/50 dark:bg-gray-900/60 border border-orange-200 dark:border-gray-700 rounded-xl text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500"
                                />
                            </div>
                            ...
                            {/* Live Link Preview */}
                            <div className="p-3 bg-orange-50 dark:bg-gray-900/60 border border-orange-200 dark:border-gray-700 rounded-xl text-xs">
                                <span className="font-semibold text-orange-800 dark:text-orange-400 block mb-0.5">Your New Link:</span>
                                <span className="font-mono text-orange-700 dark:text-orange-300 break-all">
                                    {window.location.origin}/?ref={editForm.code || 'CODE'}
                                </span>
                            </div>

                            <div className="flex items-center justify-end gap-2.5 pt-2 border-t border-orange-100 dark:border-gray-700">
                                <button
                                    type="button"
                                    onClick={() => setIsEditModalOpen(false)}
                                    className="px-4 py-2 text-sm font-semibold text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-xl transition cursor-pointer"
                                >
                                    Cancel
                                </button>
                                <button
