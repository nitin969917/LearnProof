...
export default function FriendsTab({ onViewProfile, onSelectChatUser }) {
  ...
  const handleReject = async (targetUserId) => {
    ...
    try {
      await socialApi.post('/social/remove-friendship', { targetUserId });
      fetchSocial();
    } catch (err) {
            ...
            >
              ...
              <div className="flex gap-1.5 flex-shrink-0">
                <button 
                  ...
                  className="p-2 bg-orange-500 hover:bg-orange-650 text-white rounded-full transition-all shadow shadow-orange-500/10"
            ...
            return (
              ...
              >
                <div 
                  ...
                  className="flex items-center gap-3.5 cursor-pointer min-w-0 flex-1 animate-fade-in"
                >
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  <button 
                    ...
                    className="p-2 text-orange-500 hover:bg-orange-50 dark:hover:bg-orange-950/40 rounded-xl transition"
                    title="Send Message"
                  >
